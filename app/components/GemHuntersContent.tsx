...
import Background from "../components/GenericBackground";
...
export default function GemHuntersContent({ game }: GameContentProps) {
  ...
  return (
    <Background imageSrc="/gem-hunters-background.jpg">
      <div className="w-full min-h-screen">
        {/* Hero Banner */}
        <div className="relative w-full h-[336px] md:h-[464px]">
          <Image
            src="/GameCard/gemhunters_384x576.jpg"
            alt={`${game.title} Hero`}
            layout="fill"
            objectFit="cover"
          />
