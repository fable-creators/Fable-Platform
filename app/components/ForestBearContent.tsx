...
export default function ForestBearContent({ game }: GameContentProps) {
    ...
    <div className="w-full min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="my-8">
          <h2 className="text-2xl font-bold mb-4 text-sand">About {game.title}</h2>
        ...
        <section className="my-8">
          <h2 className="text-2xl font-bold mb-4 text-sand">You May Also Like</h2>
